...
public class RangeSetTest extends TestCase {
  ...
  private static RangeSet randomRangeSet(Random rng, int num, long start, int dist) {
  ...
  public void testUnion() {
    assertEquals(
        new RangeSet(new long[] {1, 11, 20, 31, 40, 56}),
        new RangeSet(new long[] {20, 31, 40, 51}).union(new RangeSet(new long[] {1, 11, 45, 56})));
    assertEquals(
        new RangeSet(new long[] {1, 11, 45, 56}),
        new RangeSet(new long[] {}).union(new RangeSet(new long[] {1, 11, 45, 56})));
    assertEquals(
        new RangeSet(new long[] {1, 11, 45, 56}),
        new RangeSet(new long[] {1, 11, 45, 56}).union(new RangeSet(new long[] {})));
  }

  public void testIntersect() {
    assertEquals(
        new RangeSet(new long[] {22, 24, 45, 51}),
        new RangeSet(new long[] {20, 31, 40, 51})
            .intersection(new RangeSet(new long[] {1, 11, 22, 24, 45, 56})));
    assertEquals(
        new RangeSet(new long[] {20, 31, 40, 51, 90, 101, 110, 121, 200, 201}),
        new RangeSet(new long[] {10, 101, 110, 121, 200, 221})
            .intersection(new RangeSet(new long[] {20, 31, 40, 51, 90, 201})));
    assertEquals(
        new RangeSet(new long[] {}),
        new RangeSet(new long[] {20, 31, 40, 51}).intersection(new RangeSet(new long[] {})));
    assertEquals(
        new RangeSet(new long[] {}),
        new RangeSet(new long[] {}).intersection(new RangeSet(new long[] {20, 31, 40, 51})));
  }

  public void testDifference() {
    assertEquals(
        new RangeSet(new long[] {20, 31, 40, 45}),
        new RangeSet(new long[] {20, 31, 40, 51})
            .difference(new RangeSet(new long[] {1, 11, 45, 56})));
    assertEquals(
        new RangeSet(new long[] {}),
        new RangeSet(new long[] {}).difference(new RangeSet(new long[] {1, 11, 45, 56})));
    assertEquals(
        new RangeSet(new long[] {1, 11, 45, 56}),
        new RangeSet(new long[] {1, 11, 45, 56}).difference(new RangeSet(new long[] {})));
  }
  ...
  private static void rsOps(RangeSet a, RangeSet b) throws Exception {
    ...
    assertEquals(
        a.union(b).difference(a.intersection(b)).nval(),
