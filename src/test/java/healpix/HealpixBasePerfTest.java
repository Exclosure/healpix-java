...
public class HealpixBasePerfTest extends TestCase {
  ...
  private static final int nsteps = 100000; // influences number of performance tests

  private double subtest_perf_neighbours(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
  ...
  private double subtest_perf_pix2ang(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    long tstart = System.nanoTime();
    int omax = HealpixBase.order_max;
  ...
  private double subtest_perf_pix2vec(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    long tstart = System.nanoTime();
    int omax = HealpixBase.order_max;
  ...
  private double subtest_perf_pix2zphi(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    long tstart = System.nanoTime();
    int omax = HealpixBase.order_max;
  ...
  private double subtest_perf_ang2pix(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    long tstart = System.nanoTime();
    int omax = HealpixBase.order_max;
  ...
  private double subtest_perf_zphi2pix(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    long tstart = System.nanoTime();
    int omax = HealpixBase.order_max;
  ...
  private double subtest_perf_query_disc(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
  ...
  private double subtest_perf_query_polygon(String name, Scheme scheme) throws Exception {
    long cnt = 0;
    double dummy = 0;
    HealpixBase base = new HealpixBase(1024, scheme);
