 ...
 * href="http://freecode.com/projects/sleef">SLEEF</a> library. Some of the methods can be used as
 * substitutions of the corresponding methods in Math class. They have slightly less accuracy, and
 * some methods are faster compared to those methods in Math class. Please note that the methods in
 * the standard Math class are JNI methods, and the SLEEF library is specialized for SIMD
 * operations.
 */
public final class FastMath {
  ...
  /**
   * This method calculates the arc tangent of y/x in radians, using the signs of the two arguments
   * to determine the quadrant of the result. The results may have maximum error of 2 ulps.
   */
  ...
  /**
   * This method calculates the arc sine of x in radians. The return value is in the range [-pi/2,
   * pi/2]. The results may have maximum error of 3 ulps.
   */
  ...
  /**
   * This method calculates the arc cosine of x in radians. The return value is in the range [0,
   * pi]. The results may have maximum error of 3 ulps.
   */
  public static double acos(double d) {
    return mulsign(atan2k(Math.sqrt((1 + d) * (1 - d)), Math.abs(d)), d) + (d < 0 ? Math.PI : 0);
  }
