...
/**
 * Finds the smallest enclosing cone for a point set on the sphere according to Barequet & Elber:
 * Information Processing Letters 93(2005), p.83. All points are expected to be passed as unit
 * vectors. The enclosing cone must have an opening angle smaller than pi/2.
 *
