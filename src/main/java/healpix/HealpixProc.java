...
/**
 * Procedural interface to the {@link HealpixBase} functionality. This class is intended for users
 * who prefer a procedural (instead of object-oriented) interface to the HEALPix functionality. It
 * should make transition from packages like PixTools easier.
 *
...
public abstract class HealpixProc extends HealpixBase {
  ...
  public static RangeSet queryDiscInclusiveNest(int order, Pointing ptg, double radius, int fact)
      throws Exception {
    return bn[order].queryDiscInclusive(ptg, radius, fact);
  }

  public static RangeSet queryDiscInclusiveRing(int order, Pointing ptg, double radius, int fact)
      throws Exception {
  ...
  public static RangeSet queryPolygonInclusiveNest(int order, Pointing[] vertex, int fact)
      throws Exception {
    return bn[order].queryPolygonInclusive(vertex, fact);
  }

  public static RangeSet queryPolygonInclusiveRing(int order, Pointing[] vertex, int fact)
      throws Exception {
    return br[order].queryPolygonInclusive(vertex, fact);
  }

  public static RangeSet queryStripNest(int order, double theta1, double theta2, boolean inclusive)
      throws Exception {
    return bn[order].queryStrip(theta1, theta2, inclusive);
  }

  public static RangeSet queryStripRing(int order, double theta1, double theta2, boolean inclusive)
      throws Exception {
