 ...
 * because the function Vector3d.angle(Vector3d v1) is too inaccurate for usage in Healpix for very
 * small angles.
 *
...
public class Vec3 {
   ...
   * @return the angle in radians between this vector and {@code v1}; constrained to the range
   *     [0,PI].
   */
